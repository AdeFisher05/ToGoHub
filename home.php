...
<section class="Hero" id="hero">
  <div class="heroContainer">
    <?php if (!empty($_SESSION['user'])): ?>
      <h2 style='text-align: left; color: var(--panel); padding-left: 20px'>Welcome, <?php echo htmlspecialchars($_SESSION['user']['firstName']); ?>!</h2>
    <?php endif; ?>
    <div class="frame">
  ...
  <div>
    ...
    <form action="" id="fareForm">
      <div class="container grid">
        <div>
          <input type="text" name="vehicleNum" id="vehicleNum" placeholder="Vehicle Registration Number" />
        </div>
        <div>
          <input type="text" name="BoardLoc" id="BoardLoc" placeholder="Boarding from? Name of Park/Bus-stop" />
        </div>
        <div>
          <input type="text" name="dropLoc" id="dropLoc" placeholder="Drop at? Name of Park/Bus-stop" />
        </div>
        <div>
        ...
        <div>
          <input type="text" name="fareAmt" id="fareAmt" placeholder="Fare Amount" />
        </div>
        <div>
...
<section class="tabs" id="tabs" aria-labelledby="tabsTitle">
  <div class="container">
    <div class="tab-bar" role="tablist" aria-label="Service tabs">
      <button class="tab-btn" role="tab" aria-selected="true" aria-controls="tab1" id="t1">
        Pay for Ride
      </button>
      <button class="tab-btn" role="tab" aria-selected="false" aria-controls="tab2" id="t2">
        Hire Ride
      </button>
      <button class="tab-btn" role="tab" aria-selected="false" aria-controls="tab3" id="t3">
        Pay for Load
      </button>
      <button class="tab-btn" role="tab" aria-selected="false" aria-controls="tab4" id="t4">
        Pay2Park
      </button>
      <button class="tab-btn" role="tab" aria-selected="false" aria-controls="tab5" id="t5">
        Get a Shop
      </button>
    </div>

    <div id="tab1" class="tab-panel active" role="tabpanel" aria-labelledby="t1">
      <div class="grid">
        <div class="thumb">
          <img src="images/bike.jpg" alt="Bike" /><a class="view" href="./pay#bike">View more</a>
        </div>
        <div class="thumb">
          <img src="images/tricycle.jpeg" alt="Tricycle" /><a class="view" href="./pay#tricycle">View more</a>
        </div>
        <div class="thumb">
          <img src="images/car.jpeg" alt="Car" /><a class="view" href="./pay#car">View more</a>
        </div>
        <div class="thumb">
          <img src="images/highlander.jpeg" alt="Highlander" /><a class="view" href="./pay#highlander">View more</a>
        </div>
        <div class="thumb">
          <img src="images/pickup.jpg" alt="Pickup" /><a class="view" href="./pay#pickup">View more</a>
        </div>
        <div class="thumb">
          <img src="images/haice.jpeg" alt="Haice" /><a class="view" href="./pay#bus">View more</a>
        </div>
        <div class="thumb">
          <img src="images/truck.jpg" alt="Truck" /><a class="view" href="./pay#truck">View more</a>
        </div>
        <div class="thumb">
          <img src="images/coaster.png" alt="Coaster" /><a class="view" href="./pay#coaster">View more</a>
        </div>
        <div class="thumb">
          <img src="images/luxurious.jpg" alt="Luxurious" /><a class="view" href="./pay#luxurious">View more</a>
        </div>
        <div class="thumb">
          <img src="images/train.webp" alt="Train" /><a class="view" href="./pay#train">View more</a>
        </div>
        <div class="thumb">
          <img src="images/boat.jpeg" alt="Boat" /><a class="view" href="./pay#boat">View more</a>
        </div>
        <div class="thumb">
          <img src="images/tipper.jpg" alt="Tipper" /><a class="view" href="./pay#tipper">View more</a>
        </div>
      </div>
    </div>
    ...
    <div id="tab2" class="tab-panel" role="tabpanel" aria-labelledby="t2">
      <div class="grid">
        <div class="thumb">
          <img src="images/bike.jpg" alt="Bike" /><a class="view" href="#">View more</a>
        </div>
        <div class="thumb">
          <img src="images/tricycle.jpeg" alt="Tricycle" /><a class="view" href="#">View more</a>
        </div>
        <div class="thumb">
          <img src="images/car.jpeg" alt="Car" /><a class="view" href="#">View more</a>
        </div>
        <div class="thumb">
          <img src="images/highlander.jpeg" alt="Highlander" /><a class="view" href="#">View more</a>
        </div>
        <div class="thumb">
          <img src="images/pickup.jpg" alt="Pickup" /><a class="view" href="#">View more</a>
        </div>
        <div class="thumb">
          <img src="images/haice.jpeg" alt="Haice" /><a class="view" href="#">View more</a>
        </div>
        <div class="thumb">
          <img src="images/truck.jpg" alt="Truck" /><a class="view" href="#">View more</a>
        </div>
        <div class="thumb">
          <img src="images/coaster.png" alt="Coaster" /><a class="view" href="#">View more</a>
        </div>
        <div class="thumb">
          <img src="images/luxurious.jpg" alt="Luxurious" /><a class="view" href="#">View more</a>
        </div>
        <div class="thumb">
          <img src="images/train.webp" alt="Train" /><a class="view" href="#">View more</a>
        </div>
        <div class="thumb">
          <img src="images/boat.jpeg" alt="Boat" /><a class="view" href="#">View more</a>
        </div>
        <div class="thumb">
          <img src="images/tipper.jpg" alt="Tipper" /><a class="view" href="#">View more</a>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="grid">
      <div class="card product">
        ...
        <strong>Restaurants</strong><span class="price">Restauants are good place to eat</span>
